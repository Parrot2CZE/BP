...
function updateFromNumberInputs() {
  const r = clamp255(document.getElementById('r_num').value);
  const g = clamp255(document.getElementById('g_num').value);
  const b = clamp255(document.getElementById('b_num').value);
  applyRgbToControls(r, g, b, true);
}
